...
/**
 * An in-memory implementation of {@link com.hileco.drcp.http.impl.store.SubscriptionStore}, using Guava's Cache and Multimap to map subscriptions
 * by id and topic, and evict them after {@link com.hileco.drcp.core.api.services.RouterService#DEFAULT_SUBSCRIPTION_EXPIRE_MILLISECONDS}.
 */
