...
import com.hileco.lib.service.exceptions.ExceptionHandler;
...
public class EmbeddedServer {
     ...
     *
     * @param services set of jax rs services, `hileco-lib-service` providers are already included in this.
